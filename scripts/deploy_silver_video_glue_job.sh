...
SILVER_VIDEOS_TABLE="${SILVER_VIDEOS_TABLE:-clean_video_statistics}"
SOURCE="${SOURCE:-all}"
KAGGLE_RAW_PREFIX="${KAGGLE_RAW_PREFIX:-youtube/kaggle_raw/raw}"
...
aws cloudformation deploy \
  ...
  --parameter-overrides \
    ...
    SilverVideosTableName="${SILVER_VIDEOS_TABLE}" \
    Source="${SOURCE}" \
